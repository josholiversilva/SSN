...
interface UserProps {
    ...
    handleGoToWishlist: (uuid: string) => any;
}
        ...
        <>
            <div className="flex drop-shadow-md rounded-lg p-1.5 mb-5">
                ...
                <div className="flex flex-col px-5 py-1">
                    ...
                    <button className="mt-2 inline-block px-2 py-1 border bg-blue-500 text-center text-white text-sm hover:underline" onClick={() => params.handleGoToWishlist(params.user.uuid === undefined ? "" : params.user.uuid)}>
                            Wishlist
                    </button>
